...
namespace PawnSurvivors.UI.Legacy
{
    ...
    public class StageScreen : MonoBehaviour
    {
        ...
        /// <summary>
        /// 스테이지 클리어 (시간 종료) - GameFlowController에 위임
        /// </summary>
        public void OnStageClear()
        {
            ...
            // GameFlowController에 스테이지 완료 처리 위임
            ...
            {
                // Fallback: GameFlowController가 없으면 직접 처리
                LogManager.LogWarning(LogCategory.Stage, "GameFlowController가 없습니다. 직접 처리합니다.");
                if (GameManager.Instance != null)
                {
        ...
        /// <summary>
        /// 스테이지 실패 (플레이어 전멸) - GameFlowController에 위임
        /// </summary>
        public void OnStageFailed()
        {
            ...
            // GameFlowController에 스테이지 실패 처리 위임
            if (GameFlowController.Instance != null)
            {
